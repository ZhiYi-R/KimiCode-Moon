export default {
  ...
  secondaryModelHint: 'Model used by subagents and background tasks',
  noSecondaryModel: 'No subagent model',
  experimentsTitle: 'Experimental features',
